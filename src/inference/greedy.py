...
def predict_greedy(tokenizer, model, sentence, max_length=None, training=False):
    prediction = evaluate_greedy(tokenizer, model, sentence, max_length, training=training)
    sentence = [i for i in prediction if i < tokenizer.vocab_size]

...
def evaluate_beam(tokenizer, model, sentence, context, max_length, beam_size, max_hypothesis,
    ...
    predictions = beam.run([sentence, context], max_hypothesis, max_depth, alpha)
